...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \GDGFoz\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \GDGFoz\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \GDGFoz\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \GDGFoz\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \GDGFoz\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \GDGFoz\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \GDGFoz\Console\Kernel::bootstrap();
        }
    ...
    class ResponseFractal extends \GDGFoz\Hooks\ResponseFractal\ResponseFractalFacade{
        ...
        public static function parseIncludes($includes){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::parseIncludes($includes);
        }
        ...
        public static function getStatusCode(){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::getStatusCode();
        }
        ...
        public static function setStatusCode($statusCode){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::setStatusCode($statusCode);
        }
         ...
         * @static 
         */
        public static function respondItem($data, $transformer = null, $resourceKey = null, $onFail = true){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondItem($data, $transformer, $resourceKey, $onFail);
        }
         ...
         * @static 
         */
        public static function respondCollection($data, $transformer = null, $resourceKey = null){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondCollection($data, $transformer, $resourceKey);
        }
        
        /**
         * 
         *
         * @param \GDGFoz\Hooks\ResponseFractal\LengthAwarePaginator $paginator
         * @param \League\Fractal\TransformerAbstract|\Closure $transformer
         * @param string $resourceKey
         * @return mixed 
         * @static 
         */
        public static function respondPaginatedCollection($paginator, $transformer = null, $resourceKey = null){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondPaginatedCollection($paginator, $transformer, $resourceKey);
        }
         ...
         * @static 
         */
        public static function respondCreateItemSucess($item, $callback, $msg = 'Registrado com sucesso!'){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondCreateItemSucess($item, $callback, $msg);
        }
         ...
         * @static 
         */
        public static function respondUpdateItemSucess($item, $callback, $msg = 'Atualizado com sucesso!'){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondUpdateItemSucess($item, $callback, $msg);
        }
         ...
         * @static 
         */
        public static function respondCustomError($message, $errorCode, $validation = null){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondCustomError($message, $errorCode, $validation);
        }
         ...
         * @param \GDGFoz\Hooks\ResponseFractal\booleam $status error/success
         * @param array $erros Validation
         * @static 
         */
        public static function respondRespondStatus($message, $status = true, $data = array(), $erros = array()){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondRespondStatus($message, $status, $data, $erros);
        }
        
        /**
         * Generates a Response with a 403 HTTP header and a given message.
         *
         * @return \GDGFoz\Hooks\ResponseFractal\Response 
         * @static 
         */
        public static function respondEForbidden($message = 'Não autorizado, sem permissão de acesso'){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondEForbidden($message);
        }
         ...
         * @static 
         */
        public static function respondEInternalError($message = 'Erro interno de servidor, desculpe :('){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondEInternalError($message);
        }
         ...
         * @static 
         */
        public static function respondENotFound($message = 'Não encontrado'){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondENotFound($message);
        }
         ...
         * @static 
         */
        public static function respondEUnauthorized($message = 'Não logado'){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondEUnauthorized($message);
        }
         ...
         * @static 
         */
        public static function respondErrorWrongArgs($validation = null, $message = 'Erro de validação', $code = null){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondErrorWrongArgs($validation, $message, $code);
        }
        ...
        public static function respondWithArray($array, $headers = array()){
            return \GDGFoz\Hooks\ResponseFractal\ResponseFractal::respondWithArray($array, $headers);
        }
